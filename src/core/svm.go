...
func Train(param libSvm.Parameter, prob libSvm.Problem) *libSvm.Model {
...
func Setup(Traindata []TrainsetData) (libSvm.Parameter, libSvm.Problem, error) {
	...
	ProblemToAnalyze := &libSvm.Problem{L: 5, I: 0}
	...
	return *Parameters, *ProblemToAnalyze, nil
}
